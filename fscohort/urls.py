...
from .views import StudentCreateView, StudentDeleteView, StudentDetailView, StudentUpdateView, StudentListView, home, HomeView, student_list, student_add, student_detail, student_update,student_delete
